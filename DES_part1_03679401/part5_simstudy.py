...
def task_5_2_1():
    ...
    print "SIM TIME:  100s; ALPHA: 90%; NUMBER OF RUNS: " + str(results[0])
    print "SIM TIME:  100s; ALPHA: 95%; NUMBER OF RUNS: " + str(results[1])
    print "SIM TIME: 1000s; ALPHA: 90%; NUMBER OF RUNS:  " + str(results[2])
    print "SIM TIME: 1000s; ALPHA: 95%; NUMBER OF RUNS:  " + str(results[3])
    return results
