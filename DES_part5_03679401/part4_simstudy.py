...
def task_4_2_1():
    ...
    for i in range(len(list2)):
        TIAC2.count(list2[i])
    print "The Autocorrelation for the example 1 with  (lag%2 = 0) : ",  TIAC1.get_auto_cor(0)
    print "The Autocorrelation for the example 1 with  (lag%2 = 1) : ",  TIAC1.get_auto_cor(1)
    print "The Autocorrelation for the example 2 with  (lag%3 = 0) : ",  TIAC2.get_auto_cor(0)
    print "The Autocorrelation for the example 2 with  (lag%3 = 1) : ",  TIAC2.get_auto_cor(1)
    print "The Autocorrelation for the example 2 with  (lag%3 = 2) : ",  TIAC2.get_auto_cor(2)
